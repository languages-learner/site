...
class Api {
    ...
    async GetLanguages() {
        return new Promise((resolve, reject) => {
            apiCall({ url: '/WebApi/GetLanguages' }).then(data => {
                resolve(data)
            })
        })
    }
    ...
    async GetWordGroups() {
        return new Promise((resolve, reject) => {
            return apiCall({ url: '/WebApi/GetWordGroups' }).then(data => {
                resolve(data)
            })
        })
    }

    async GetTranslates(languagesId) {
        return new Promise((resolve, reject) => {
            return apiCall({
    ...
    async GetAssotiations() {
        return new Promise((resolve, reject) => {
            return apiCall({ url: '/WebApi/GetAssotiations' }).then(data => {
                resolve(data)
            })
        })
    }
    ...
    async AddWordGroup(name) {
        return new Promise((resolve, reject) => {
            return apiCall({ url: '/WebApi/AddWordGroup?name=' + name }).then(
                data => {
                    resolve(data)
                }
            )
    ...
    async GetRules() {
        return new Promise((resolve, reject) => {
            return apiCall({ url: '/WebApi/GetRules' }).then(data => {
                resolve(data)
            })
        })
    }
    ...
    async GetTaskGeneralInformation() {
        return new Promise((resolve, reject) => {
            return apiCall({ url: '/WebApi/GetTaskGeneralInformation' }).then(
                data => {
                    resolve(data)
                }
            )
    ...
    async GetTasks() {
        return new Promise((resolve, reject) => {
            return apiCall({ url: '/WebApi/GetTasks' }).then(data => {
                resolve(data)
            })
        })
    }
